...
BLOG_AUTHOR = "Mathieu"  # (translatable)
BLOG_TITLE = "Ontoblogie"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://ontoblogie.clabaut.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://ontoblogie.clabaut.net/"
BLOG_EMAIL = "mathieu@clabaut.net"
BLOG_DESCRIPTION = {'fr': "Éructations diverses et (a)variées principalement autour de sujets de société et de l'informatique  ",
                    'en': "Miscenalleous and motley eructations mainly about society and computer science" }# (translatable)
...
AUTHOR_PAGES_DESCRIPTIONS = {
   DEFAULT_LANG: {
       "Mathieu": "Créateur de https://rendre.fr,  ",
   },
}
...
FRONT_INDEX_HEADER = {
    DEFAULT_LANG:  "<div class='subtitle'>Éructations diverses et (a)variées</div>",
    'en': "<div class='subtitle'>Miscenalleous and motley eructations</div>"
}
...
REDIRECTIONS = [
    ...
    ('2012/04/une-escarmouche.html', '/posts/2012/04/une-escarmouche.html'),
    ('2012/04/des-votes-des-votes-oui-mais-pas.html', '/posts/2012/04/des-votes-des-votes-oui-mais-pas.html'),
    ('2011/11/ci-dessous-une-petite-animation-creee.html', '/posts/2011/11/ci-dessous-une-petite-animation-creee.html'),
    ('2011/08/journalisme-politique-mensonges-et.html', '/posts/2011/08/journalisme-politique-mensonges-et.html'),
    ('2011/08/photos-de-rue-carnaval-de-la-tour.html', '/posts/2011/08/photos-de-rue-carnaval-de-la-tour.html'),
    ('2011/06/spectacle-de-cirque.html', '/posts/2011/06/spectacle-de-cirque.html'),
    ('2011/05/france-pays-des-droits-de-lhomme.html', '/posts/2011/05/france-pays-des-droits-de-lhomme.html'),
    ('2011/04/lil-buck-and-yo-yo-ma.html', '/posts/2011/04/lil-buck-and-yo-yo-ma.html'),
    ('2011/03/affiche-promenade-contee-sur-le-theme.html', '/posts/2011/03/affiche-promenade-contee-sur-le-theme.html'),
    ('2011/03/france-ennemie-de-linternet-pas-encore.html', '/posts/2011/03/france-ennemie-de-linternet-pas-encore.html'),
    ('2011/03/toutes-les-fleurs-au-monde.html', '/posts/2011/03/toutes-les-fleurs-au-monde.html'),
    ('2011/03/francais-dorigine-etrangere.html', '/posts/2011/03/francais-dorigine-etrangere.html'),
    ('2011/02/une-excuse.html', '/posts/2011/02/une-excuse.html'),
    ('2011/01/affiche-jeux-de-societe.html', '/posts/2011/01/affiche-jeux-de-societe.html'),
    ('2010/12/censure-suite.html', '/posts/2010/12/censure-suite.html'),
    ('2010/12/internet-sous-la-censure-du.html', '/posts/2010/12/internet-sous-la-censure-du.html'),
    ('2010/12/de-la-sur-ingenierie-dans-lautomobile.html', '/posts/2010/12/de-la-sur-ingenierie-dans-lautomobile.html'),
    ('2010/11/des-notes-de-bas-de-pages-sur-blogger.html', '/posts/2010/11/des-notes-de-bas-de-pages-sur-blogger.html'),
    ('2010/09/affiche-petite-retrospective.html', '/posts/2010/09/affiche-petite-retrospective.html'),
    ('2010/09/affiche-promenade-contee-sur-le-theme.html', '/posts/2010/09/affiche-promenade-contee-sur-le-theme.html'),
    ('2010/09/banderole.html', '/posts/2010/09/banderole.html'),
    ('2010/09/pourquoi-jai-manifeste-mon-pere.html', '/posts/2010/09/pourquoi-jai-manifeste-mon-pere.html'),
    ('2010/09/esperance-de-vie-et-retraites.html', '/posts/2010/09/esperance-de-vie-et-retraites.html'),
    ('2011/08/street-photos-carnaval-de-la-tour.html', '/posts/2011/08/street-photos-carnaval-de-la-tour.html'),
    ('2010/11/easy-footnotes-on-blogger.html', '/posts/2010/11/easy-footnotes-on-blogger.html'),
]
...
FILTERS = {
   ".html": [filters.typogrify, filters.add_header_permalinks,filters.deduplicate_ids],
...
LICENSE = {
    'fr': """
<p>Le contenu de
    ce blog est mis à disposition selon les termes de la <a rel="license"
    href="http://creativecommons.org/licenses/by/4.0/">Licence Creative Commons
    Attribution 4.0 International</a>&nbsp;<a rel="license" href="http://creativecommons.org/licenses/by/4.0/"><img
    alt="Licence Creative Commons" style="border-width:0"
    src="https://i.creativecommons.org/l/by/4.0/88x31.png" /></a></p>
""",
    'en': """<p>This blog content
    s distributed under the <a rel="license"
    href="http://creativecommons.org/licenses/by/4.0/">Creative Commons
    Attribution 4.0 International License</a>&nbsp;<a rel="license"
    href="http://creativecommons.org/licenses/by/4.0/"><img alt="Licence
...
EXTRA_HEAD_DATA="""
<link href="https://fonts.googleapis.com/css?family=Raleway:100,100i,200,400,400i,700&amp;subset=latin-ext" rel="stylesheet">
"""
# USE_KATEX = False
...
TWITTER_CARD = {
      ...
      'site': '@matclab',         # twitter nick for the website
      'creator': '@matclab',     # Username for the content creator / author.
 }
